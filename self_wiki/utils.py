...
class RecentFileManager:
    ...
    @classmethod
    def get_recent_files(cls, directory: str,
                         limit=DEFAULT_LIMIT,
                         wanted_extensions: Optional[List[str]] = None) -> List[dict]:
        """
        ...
        :type limit: int
        :param wanted_extensions: A list of file extensions we want. If None, ['md'] is used.
    ...
    def __init__(self, root: str, wanted_extensions: Optional[List[str]] = None):
        self._root = root
        self._file_list = RecentFileManager.get_recent_files(directory=root,
    ...
    def re_scan(self, limit: Optional[int] = None, wanted_extensions: List[str] = ('md',)):
        ...
        :return:
        """
        self._file_list = RecentFileManager.get_recent_files(directory=self.root,
                                                             limit=limit,
                                                             wanted_extensions=wanted_extensions)
